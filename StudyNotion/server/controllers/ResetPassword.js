...
exports.resetPasswordToken = async (req,res) =>{
    try{
		...
		console.log("DETAILS for password change with token", updatedDetails);
        console.log("token for password reset is : ",updatedDetails.token);
...
exports.resetPassword = async (req,res) =>{
    try{
        // data fetch 
        const {password , confirmPassword, token} = req.body; // we have sent token in url so how it is coming in body? => so the frontend basically puts this token in body
